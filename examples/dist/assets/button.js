...
{
	if (region.Q.F === region.U.F)
	{
		return 'on line ' + region.Q.F;
	}
	return 'on lines ' + region.Q.F + ' through ' + region.U.F;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { aA: 'hidden', E: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { aA: 'mozHidden', E: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { aA: 'msHidden', E: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { aA: 'webkitHidden', E: 'webkitvisibilitychange' }
		: { aA: 'hidden', E: 'visibilitychange' };
}
...
var author$project$Button$Click = 0;
...
var author$project$Dom$element = function (tag) {
	return {u: _List_Nil, e: _List_Nil, m: _List_Nil, Y: '', N: _List_Nil, a: _List_Nil, ab: '', o: _List_Nil, aq: tag, A: ''};
};
...
var author$project$Dom$Internal$render = function (_n0) {
		...
		if (_n5 === '') {
			...
			return elm$core$List$cons(
				A2(
					...
					elm$virtual_dom$VirtualDom$text(data.A)));
		}
	}();
		...
		if (_n3 === '') {
			...
			return elm$core$List$cons(
				A2(
					...
					'id',
					elm$json$Json$Encode$string(data.Y)));
		}
	}();
	...
	var allAttributes = consId(
		consClassName(
			prependStyles(
				prependListeners(data.u))));
	var _n1 = _Utils_Tuple2(data.ab, data.N);
	if (_n1.a === '') {
		if (!_n1.b.b) {
			return A3(
			...
			return A3(
				...
				allAttributes,
				consTextKeyed(
					A3(elm$core$List$map2, elm$core$Tuple$pair, data.N, data.e)));
		}
	} else {
		if (!_n1.b.b) {
			return A4(
	...
	return author$project$Dom$Internal$modify(
		function (n) {
			return _Utils_update(
				n,
				{
					A: A2(elm$core$String$append, n.A, s)
				});
		});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {W: fragment, X: host, ad: path, af: port_, aj: protocol, ak: query};
	});
